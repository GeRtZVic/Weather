 ...
 */
class ElogicWeatherBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'ElogicWeather';

    /**
     * Url paths.
     * #@+
     */
    private const EDIT_URL_PATH = 'elogic_weather/elogicweather/edit';
    private const DELETE_URL_PATH = 'elogic_weather/elogicweather/delete';
    /** #@- */
